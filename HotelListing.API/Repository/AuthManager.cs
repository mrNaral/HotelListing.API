...
namespace HotelListing.API.Repository
{
    public class AuthManager : IAuthManager
    {
        ...
        public async Task<IEnumerable<IdentityError>> AdminRegister(ApiAdminDto apiAdminDto)
        {
            var adminUser = _mapper.Map<ApiUser>(apiAdminDto);
            adminUser.UserName = apiAdminDto.Email;
            adminUser.IsAdmin = true;

            var result = await _userManager.CreateAsync(adminUser, apiAdminDto.Password);
